##### Prometheus operator installation using helm charts
...
- Accessing `Prometheus` dashboard: http://127.0.0.1:9090
    ```bash
    /charts$ kubectl --namespace default port-forward svc/prometheus-operator-158056-prometheus 9090
    Forwarding from 127.0.0.1:9090 -> 9090
    Forwarding from [::1]:9090 -> 9090
    ```

- Accessing `Grafana` dashboard: http://127.0.0.1:8000
    ```bash
    $ kubectl --namespace default port-forward svc/prometheus-operator-1580567000-grafana 8000:80
